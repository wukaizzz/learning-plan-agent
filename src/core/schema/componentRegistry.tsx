...
import { PlanChangePreview } from '@/components/ui-blocks/PlanChangePreview/PlanChangePreview';
import { ScheduleTaskList } from '@/components/ui-blocks/ScheduleTaskList/ScheduleTaskList';
...
const BLOCK_REGISTRY: Record<string, React.ComponentType<any>> = {
  ...
  'plan-change-preview': PlanChangePreview,
  'schedule-task-list': ScheduleTaskList
};
